CREATE TABLE users (
    ...
    balance INTEGER CHECK (balance >= 0) DEFAULT 100,
...
CREATE TABLE transactions (
    ...
    from_user INTEGER REFERENCES users ON DELETE CASCADE DEFAULT NULL,
    to_user INTEGER NOT NULL REFERENCES users ON DELETE CASCADE,
    action TEXT NOT NULL,
    item_id INTEGER REFERENCES items ON DELETE CASCADE DEFAULT NULL,
